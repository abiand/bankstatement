...
$directory = //["C:/nginx/html/bankstatement/files/ScanBank/BCA", 
		// ["C:/nginx/html/bankstatement/files/ScanBank/Mandiri"];
		  ["C:/nginx/html/bankstatement/files/ScanBank/Danamon"];


        
//$nanonetsApiUrl = 'https://app.nanonets.com/api/v2/OCR/Model/9d446474-624a-4674-bc8f-487664244195/LabelFile/';
                                               
$nanonetsApiUrl = 'https://app.nanonets.com/api/v2/OCR/Model/7d4b3832-190b-4ced-9cfa-af0eadc24361/LabelFile/';
//$nanonetsAuth = ['ae81bd42-fd53-11ee-8637-0e7fc6dd2f51', '']; // Basic Auth
...
foreach ($directory as $path) {
    ...
    foreach ($processFiles as $filename) {
            $filepath = $path . DIRECTORY_SEPARATOR . $filename;
        

            try {
                // Make the POST request to the Nanonets API
               ...
               // $json_data =  nl2br(htmlspecialchars($response->getBody()->getContents()));
                ...
                if($jsonArrayResponse['message'] == "Success") {
                    ...
                    if ($Norek == "0001982651"){
                        ...
                        if (strpos($Period, '-') !== false) {/*
                            ...
                            $PeriodNumberD = null; 
                           // echo "conto ".$matches;
                            echo "jegal period ZZZ ".$Period."<br>";
                            if (preg_match('/\d{2} - \d{2} ([a-zA-Z]+)/', ltrim(rtrim($Period)), $matches)) {
                              //echo "sabe  ".$matches[1]."<br>";
                                $monthName = $matches[1];
                                $PeriodNumberD = $months[$monthName] ?? null; // Return the month number or null if not found
                            }
                           // echo "jegal period QQQ".$PeriodNumberD;  */



                          // $dateString = "01-31 Juli 2024";

                           // Extract the month name using regex or string manipulation
                           ...
                           // Map Indonesian month names to their numeric values
                           $indonesianMonths = [
                               'Januari' => 1,
                               'Februari' => 2,
                               'Maret' => 3,
                               'April' => 4,
                               'Mei' => 5, // Note: "Mei" is the correct spelling for May in Indonesian
                               'Juni' => 6,
                               'Juli' => 7,
                               'Agustus' => 8,
                               'September' => 9,
                           ...
                           //echo "Month as integer: " . $monthInt; // Output: 7



                            generateQueryGL("00000315",$fiscalYear,$PeriodNumber);
                        } else {
                    ...
                    //MANDIRI
                        ...
                        $Bank_Name = "Mandiri";  
                        generateQueryGL("00000317",$fiscalYear,$PeriodNumber);
                    //BCA
                    }else{
                        $Bank_Name = "BCA";
                        ...
                        generateQueryGL("00000311",$fiscalYear,$PeriodNumber);
                    }
                                ...
                                if ($connect->query($sqlInsertHeader) === TRUE) {
                                    ...
                                    foreach ($dataDetails as $values) {
                                        ...
                                        if ($Norek == "1150094006345"){
                                            ...
                                            $Remark 		= str_replace("'", "", $values['Remark']);
                                            ...
                                            $Remark 		= str_replace("'", "", $values['Desc']);
                                            $Debit 			= str_replace([',', '.'], '', $values['Debit']);
                                            $Kredit 		= str_replace([',', '.'], '', $values['Kredit']);
                                            if ($Debit == "0"){
                                                $codetransaction = "CR";
...
/////////////////////////////////////////////CATCH/////////////////////////////////////////////////////
                ...
                // Handle errors and display the response if available
                echo "Request error for $filename: " . $e->getMessage();
                if ($e->hasResponse()) {
